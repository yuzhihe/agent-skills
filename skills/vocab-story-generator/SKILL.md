...
一般让一个新的单词或短语获得约 17–22 个英文正文词的上下文。完整句子的认知负担更高，应降低单 Part 容量。少量条目不强求密度；复杂专业词应增加铺垫。输入超过 30 项时，按主题拆为多个 Part；规模很大时再拆成多个主题文件。保留既有“大批量词表采用多主题、每个主题 2–4 个 Part”的总体效果。
